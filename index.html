...
<p class="footer">Copyright &copy; {{ site.time | date: '%Y' }} {{ site.author.name }}, licensed under <a href="https://github.com/juthilo/run-jekyll-on-windows/blob/gh-pages/LICENSE" target="_blank">CC-BY-3.0</a>.
